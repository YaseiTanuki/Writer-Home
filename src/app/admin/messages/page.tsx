...
export default function AdminMessages() {
  ...
  return (
    <div className="min-h-screen bg-[#181825] text-[#cdd6f4]">
      
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-6">
        {/* Header */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className="flex items-center gap-2 sm:gap-3">
            <Link href="/admin" className="inline-flex items-center justify-center p-2 text-[#6c7086] hover:text-[#cdd6f4] transition-all duration-200 rounded-md bg-[#313244]/50 hover:bg-gray-700/50 backdrop-blur-sm border border-[#45475a]">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="relative">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-pink-500 to-rose-500 rounded-md flex items-center justify-center shadow-md">
                  <Mail size={16} className="sm:w-5 text-[#cdd6f4]" />
                </div>
              ...
              <div>
                ...
                <div className="text-xs sm:text-sm text-[#6c7086]">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="text-right">
              <p className="text-xs sm:text-sm text-[#6c7086]">Tổng tin nhắn</p>
            ...
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-gray-700 to-gray-600 rounded-full flex items-center justify-center shadow-md">
              <span className="text-xs sm:text-sm font-medium text-[#cdd6f4]">N</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3 sm:space-y-4 px-1 sm:px-4">
          {messages.map((message) => (
            <div key={message._id} className="bg-[#313244]/50 rounded-md border border-[#45475a] p-3 sm:p-4 backdrop-blur-sm hover:bg-gray-700/50 transition-all duration-200 hover:scale-102">
              <div className="flex items-start gap-2 sm:gap-4">
                ...
                <div className="flex-shrink-0">
                  ...
                  <div className={`h-10 w-10 sm:h-16 sm:w-16 rounded-full bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center ${message.guestPicture ? 'hidden' : ''}`}>
                    <User size={14} className="text-[#cdd6f4] sm:w-5" />
                  </div>
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-3 sm:mt-4">
                    <Link
                      ...
                      className="inline-flex items-center justify-center gap-1 px-2 py-1.5 sm:px-3 sm:py-2 border border-gray-600 text-xs sm:text-sm font-medium rounded-md text-[#a6adc8] bg-[#313244] hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 transition-colors duration-200"
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-1 px-2 py-1.5 sm:px-3 sm:py-2 border border-red-600 text-xs sm:text-sm font-medium rounded-md text-red-400 bg-[#313244] hover:bg-red-900/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200"
                    >
        ...
        {messages.length === 0 && !isLoadingData && (
          <div className="text-center py-6 sm:py-8">
            ...
            <h3 className="text-lg font-medium text-[#6c7086] mb-2">Chưa có tin nhắn nào</h3>
            <p className="text-sm text-[#6c7086] mb-6">Chưa có tin nhắn nào trong hộp thư</p>
          </div>
        )}
            ...
            <div className="flex items-start">
              ...
              <div className="ml-2 sm:ml-3">
                ...
                <div className="mt-1 sm:mt-2 text-xs sm:text-sm text-yellow-300 space-y-1">
                  ...
                  <p>• Đánh dấu &ldquo;Đã trả lời&rdquo; khi bạn đã phản hồi người gửi</p>
                  <p>• Xóa tin nhắn không còn cần thiết để giữ gọn hộp thư</p>
                  <p>• Bấm &ldquo;Xem&rdquo; để xem chi tiết tin nhắn và trả lời</p>
            ...
            <div className="relative bg-[#181825] rounded-lg shadow border border-[#45475a]">
              <div className="p-4 sm:p-6 text-center">
                ...
                <h3 className="mb-3 sm:mb-5 text-base sm:text-lg font-normal text-[#cdd6f4]">
                  Bạn có chắc chắn muốn xóa tin nhắn &ldquo;{deleteConfirm.name}&rdquo; không?
                </h3>
