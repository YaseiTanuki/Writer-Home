...
export default function AdminStories() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#1e1e2e' }}>
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 py-4 sm:py-6">
        ...
        <div className="mb-4 sm:mb-6 px-2 sm:px-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
              ...
              <div>
                <div className="relative mb-2">
                  <h1 className="text-lg sm:text-xl font-bold text-[#cdd6f4] flex items-center gap-2 sm:gap-3">
                    <BookOpen size={20} className="text-[#89b4fa]" />
                    <span className="hidden sm:inline">Quản Lý Truyện</span>
                    <span className="sm:hidden">Truyện</span>
                  </h1>
                  <div className="absolute -top-1 left-1/2 transform -translate-x-1/2 w-1 h-1 bg-[#cba6f7] rounded-full animate-pulse"></div>
                </div>
            ...
            <Link
              ...
              className="bg-[#89b4fa] hover:bg-[#89b4fa]/90 text-[#11111b] px-3 sm:px-6 py-2 sm:py-3 rounded-lg font-medium transition-all duration-300 text-xs sm:text-sm flex items-center gap-1.5 sm:gap-2 w-full sm:w-auto justify-center shadow-md hover:shadow-lg hover:scale-105"
            >
        ...
        <div className="space-y-3 sm:space-y-4">
          {stories.map((story, index) => {
            ...
            return (
              <div key={story._id} className="bg-[#313244] rounded-2xl border-2 p-4 sm:p-6 hover:shadow-lg transition-all duration-200 backdrop-blur-sm hover:scale-102" style={{ borderColor: currentNeonColor, boxShadow: `0 0 8px ${currentNeonColor}` }}>
                  ...
                  <div className="flex-shrink-0">
                    {story.coverImage ? (
                      ...
                      <div className="h-16 w-16 sm:h-20 sm:w-20 rounded-lg flex items-center justify-center" style={{ backgroundColor: currentNeonColor }}>
                        <BookOpen size={20} className="text-[#cdd6f4] sm:w-6" />
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 sm:gap-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="hidden sm:block text-sm text-[#a6adc8] mb-2 line-clamp-2">
                          {story.description}
                        </p>
                        
                        {/* Date */}
                        <div className="flex items-center gap-2 text-xs sm:text-sm text-[#a6adc8]">
                      ...
                      <div className="flex-shrink-0">
                        {story.status === 'public' ? (
                          <span className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium rounded-full bg-[#fab387]/20 text-[#fab387] border-2 border-[#fab387]/50 whitespace-nowrap">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 mt-3 sm:mt-4">
                      <Link
                        ...
                        className="inline-flex items-center justify-center gap-1 px-3 py-2 border-2 border-[#cba6f7] text-xs sm:text-sm font-medium rounded-lg text-[#89b4fa] bg-[#313244] hover:bg-[#89b4fa]/10 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#cba6f7] transition-colors duration-200"
                      >
        ...
        {stories.length === 0 && !isLoadingData && (
          <div className="text-center py-6 sm:py-8">
            <div className="bg-[#313244] rounded-2xl border border-[#45475a] p-8 max-w-md mx-auto ">
              <BookOpen size={48} className="mx-auto text-[#89b4fa] mb-4" />
              <h3 className="text-lg font-medium text-[#cdd6f4] mb-2">Chưa có truyện nào</h3>
              <p className="text-sm text-[#a6adc8] mb-6">Bắt đầu tạo truyện đầu tiên của bạn</p>
              <Link
                href="/admin/new-story"
                className="bg-[#89b4fa] hover:bg-[#89b4fa]/90 text-[#11111b] px-6 py-3 rounded-lg font-medium transition-all duration-200 shadow-md hover:shadow-lg"
              >
                Tạo Truyện Mới
              </Link>
            </div>
      ...
      {deleteConfirm && (
        <div className="fixed inset-0 bg-[#181825]/50 backdrop-blur-sm overflow-y-auto h-full w-full flex items-center justify-center z-50 p-4">
          <div className="relative p-4 sm:p-8 border w-full max-w-md max-h-full">
            <div className="relative bg-[#313244] rounded-2xl shadow-lg border border-[#45475a]">
              <div className="p-4 sm:p-6 text-center">
                                  <svg className="mx-auto mb-4 text-[#89b4fa] w-10 h-10 sm:w-12 sm:h-12" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                ...
                <p className="mb-3 sm:mb-4 text-xs sm:text-sm text-[#89b4fa] bg-[#89b4fa]/10 p-2 sm:p-3 rounded-lg border-2 border-[#cba6f7]/30">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-2 sm:gap-4">
                  <button
                    ...
                    className="text-[#11111b] bg-[#89b4fa] hover:bg-[#89b4fa]/90 focus:ring-4 focus:outline-none focus:ring-[#cba6f7]/50 font-medium rounded-lg text-xs sm:text-sm px-4 sm:px-5 py-2 sm:py-2.5 text-center shadow-md hover:shadow-lg"
                  ...
                  <button
                    ...
                    className="text-[#a6adc8] bg-[#313244] hover:bg-[#181825] focus:ring-4 focus:outline-none focus:ring-[#cba6f7]/50 font-medium rounded-lg text-xs sm:text-sm px-4 sm:px-5 py-2 sm:py-2.5 text-center border-2 border-[#cba6f7]/50 hover:border-[#cba6f7] transition-all duration-200"
                  >
                    Hủy
                  </button>
                </div>
        ...
        <div className="fixed top-16 sm:top-20 left-2 right-2 sm:left-4 sm:right-4 z-50 max-w-sm mx-auto sm:mx-0">
          <div className={`rounded-2xl shadow-lg p-3 sm:p-4 border-2 ${
            notification.type === 'success' 
              ? 'bg-[#fab387]/10 border-[#fab387] text-[#fab387]' 
              : 'bg-[#89b4fa]/10 border-[#cba6f7] text-[#89b4fa]'
          }`}>
            <div className="flex items-start">
              <div className="flex-shrink-0">
                {notification.type === 'success' ? (
                  <CheckCircle size={18} className="text-[#fab387] sm:w-5" />
                ) : (
                  <AlertTriangle size={18} className="text-[#89b4fa] sm:w-5" />
                )}
              </div>
              ...
              <div className="ml-2 sm:ml-4 flex-shrink-0">
                <button
                  ...
                  className={`inline-flex rounded-md p-1 sm:p-1.5 ${
                    notification.type === 'success' 
                                        ? 'text-[#fab387] hover:bg-[#fab387]/10' 
                  : 'text-[#89b4fa] hover:bg-[#89b4fa]/10'
                  } focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#1e1e2e] focus:ring-[#cba6f7] transition-all duration-200`}
                >
