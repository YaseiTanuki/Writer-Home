      ...
      <div className="pt-16 md:pt-24 max-w-7xl mx-auto px-1 sm:px-4 py-2 sm:py-6">
        ...
        <div className="mb-2 sm:mb-6 px-1 sm:px-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
            <div className="flex items-center gap-2 sm:gap-4">
              <Link
                href="/admin"
                className="p-1 sm:p-2 rounded-md bg-[#313244] hover:bg-[#181825] transition-all duration-200 backdrop-blur-sm border border-[#45475a]/30 hover:border-[#45475a]/50"
              >
                <ArrowLeft size={16} className="text-[#89b4fa] sm:w-[18px]" />
              </Link>
              <div>
                <div className="relative mb-1">
                  <h1 className="text-lg sm:text-xl font-bold text-[#cdd6f4] flex items-center gap-2 sm:gap-3">
                  <FileText size={20} className="text-[#89b4fa] sm:w-6" />
                ...
                <div className="text-xs sm:text-sm text-[#a6adc8] mt-0.5 sm:mt-1">
            ...
            <div className="flex flex-col sm:flex-row gap-1.5 sm:gap-3">
              ...
              {chapters.some(chapter => !isChapterLinkedToStory(chapter)) && (
                <button
                  ...
                  className="bg-[#89b4fa] hover:bg-[#89b4fa]/90 text-[#11111b] px-2 sm:px-4 py-1.5 sm:py-3 rounded-md font-medium transition-all duration-300 text-xs sm:text-sm flex items-center gap-1 sm:gap-2 w-full sm:w-auto justify-center shadow-md hover:shadow-lg hover:scale-105"
                >
              ...
              <Link
                ...
                className="bg-[#89b4fa] hover:bg-[#89b4fa]/90 text-[#11111b] px-2 sm:px-6 py-1.5 sm:py-3 rounded-md font-medium transition-all duration-300 text-xs sm:text-sm flex items-center gap-1 sm:gap-2 w-full sm:w-auto justify-center shadow-md hover:shadow-lg hover:scale-105"
              >
        ...
        <div className="space-y-2 sm:space-y-4">
          ...
          {chapters.map((chapter) => (
            <div key={chapter._id} className="bg-[#181825]/50 rounded-md border border-[#45475a] p-3 sm:p-6 hover:bg-gray-800/50 transition-all duration-200 backdrop-blur-sm hover:scale-102">
              <div className="flex items-start gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                     ...
                     <div className="flex-1 min-w-0">
                       <h3 className="text-sm sm:text-lg font-semibold text-[#cdd6f4] truncate">
                         {chapter.title}
                       </h3>
                     </div>
                   ...
                   {/* Story Title */}
                   <div className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-[#6c7086] mb-1.5 sm:mb-2">
                   ...
                   {/* Date */}
                   <div className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-[#6c7086]">
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-3 mt-2 sm:mt-4">
                    <Link
                      ...
                      className="inline-flex items-center justify-center gap-1 px-2 sm:px-3 py-1.5 sm:py-2 border border-gray-600 text-xs sm:text-sm font-medium rounded-md text-[#a6adc8] bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 transition-colors duration-200"
                    >
        ...
        {chapters.length === 0 && !isLoadingData && (
          <div className="text-center py-8 sm:py-12">
            ...
            <h3 className="text-base sm:text-lg font-medium text-[#6c7086] mb-1.5 sm:mb-2">Chưa có chương nào</h3>
            <p className="text-xs sm:text-sm text-gray-500 mb-4 sm:mb-6">Bắt đầu tạo chương đầu tiên của bạn</p>
            <Link
              href="/admin/new-chapter"
              className="bg-green-600 hover:bg-green-700 text-[#cdd6f4] px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-medium transition-colors duration-200 text-sm"
            >
              Tạo Chương Mới
            </Link>
          </div>
              ...
              <div className="p-4 sm:p-6 text-center">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-2 sm:gap-4">
                  ...
                  <button
                    ...
                    className="text-[#a6adc8] bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-600 font-medium rounded-lg text-xs sm:text-sm px-4 sm:px-5 py-2 sm:py-2.5 text-center border border-gray-600"
                  >
                    Hủy
                  </button>
                </div>
